...
const AplicationFormPage = () => {
  ...
  const navigate = useNavigate()
   const goBack = () => {
    ...
    axios
      .get
      (`https://us-central1-labenu-apis.cloudfunctions.net/labeX/janayna-cortez-hooks/trips/`)
...
const applyToTrip = (e) => {
  ...
  axios
  .post(
    `https://us-central1-labenu-apis.cloudfunctions.net/labeX/janayna-cortez-hooks/trips/${form.tripId}/apply`,
   body)
   .then((ress)=>{
...
const mapTrip = tripslist.map((trip, i)=>{
    ...
    <div>
      ...
      <div className="container">
       ...
       <p className=" mt-4 mb-5 pb-5">
         ...
         Ao enviar sua candidatura será feita a análise e em
         3 dias você receberá resposta.
         </p>
  ...
  <select className="form-control" name={"tripId"} 
  value={form.tripId} onChange={onChangeForm} required>
 ...
 required/>
  ...
  <div className="form-group p-3">
        ...
        value={form.country} required onChange={onChangeForm}>
  ...
  <p className="text-center mb-3 mt-2 pb-3"> <div 
       className="btn-group" 
 role="group">
      <Button  type="submit"
